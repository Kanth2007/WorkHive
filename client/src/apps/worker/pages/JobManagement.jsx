    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)', paddingBottom: 'var(--space-xl)' }}>
      ...
      {currentStepIndex < 4 ? (
        <>
          ...
          {/* 4. LIVE GPS ROUTE & WORKER LIVE LOCATION MAP */}
          <TrackingMap
            workerName={job.customer || 'Customer Destination'}
            workerCategory={job.category}
            statusIndex={currentStepIndex === 0 ? 1 : currentStepIndex === 1 ? 2 : currentStepIndex + 1}
            isSharingLocation={isSharingLocation}
            customerZone={job.address}
            isPending={false}
            isWorkerSide={true}
          />
